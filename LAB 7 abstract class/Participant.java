...
// Difinition input function for display User Info
 ...
 class Sponsor extends Orgadniser
 { 
...
public void DisplaySponsorDetails()
	...
	// Scanner sc = new Scanner(System.in)
		...
		if(sponsorType==1)
		{
			System.out.println(" Sponsor is :Platinum");
		}
		else if(sponsorType==2)
		{
			System.out.println(" Sponsor is :Gold");
		}
		else if(sponsorType==3)
		{
			System.out.println(" Sponsor is :Silver");
		}
...
public  static  void main(String args[])
	{
			...
			short id;
			Scanner scan = new Scanner(System.in); 
			// Hackathon usern = new Hacka.thon();
