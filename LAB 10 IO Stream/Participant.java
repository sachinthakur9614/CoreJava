	...
	public  void eventDetails()
		 {
...

		 	{
		 		...
		 		OutputStream output = new FileOutputStream("Event.txt");
		 		
			 
			 	System.out.println("\nEnter Event Name:");
				output.write("\n Event Name:".getBytes());
			 	eventName = scan.next();
			 	output.write(eventName.getBytes());
				System.out.print("\nEnter Organised By:");
				organisedBy = scan.next();
				output.write("\n Organised By:".getBytes());
				output.write(organisedBy.getBytes());


				System.out.print("\nEnter Organised Email:");
				organiserEmail = scan.next();		 
				output.write("\n Organiser Email:".getBytes());
				output.write(organiserEmail.getBytes());

				System.out.print("\nEnter Contact Person:");
				conatctPersonName = scan.next();
				output.write("\n Contact Person Name:".getBytes());
				output.write(conatctPersonName.getBytes());

				System.out.print("\nEnter Number Of Events :");
				numberOfEvents = scan.nextInt();
				output.write("\n Number of Events:".getBytes());
				output.write(numberOfEvents.toString().getBytes());

				System.out.print("\nEnter Event Charge:");
				eventCharge = scan.nextFloat();
				output.write("\n Event Charge:".getBytes());
				output.write(eventCharge.toString().getBytes());

				System.out.print("\nEnter Number of Team Member:");
				teamMember = scan.nextInt();
				output.write("\n Team Member:".getBytes());
				output.write(teamMember.toString().getBytes());
				System.out.print("\nEnter Expected Teams:");
				expectedTeams = scan.nextInt();
				output.write("\n Expected Team:".getBytes());
				output.write(teamMember.toString().getBytes());
				// System.out.print("\nEnter Start Date:");
				startDate = new Date();
				// System.out.print("\nEnter End Date:");
				...
				output.write("\n Mobile Number:".getBytes());
				output.write(contactMobileNo.toString().getBytes());
...
String sponosorOfficeLoc;
	...
	public void readSponsorDetails()
	{
		...
		try {
		OutputStream output = new FileOutputStream("sponsor.txt");
		...
		sponsorOrgName = sc.next();
		 output.write("\n Org Name:".getBytes());
			 	output.write(sponsorOrgName.getBytes());

		System.out.print("\nEnter Sponsor Org Email:");
		sponsorOrgEmail = sc.next();
		output.write("\n Sponsor Org Email:".getBytes());
		output.write(sponsorOrgEmail.getBytes());
...
public void readParticiapntInfo() throws IOException
{
			System.out.print("\n\tREADING PARTICIPANT BASIC INFORMATION");
		 	...
		 	try{
			 	...
			 	output.write("\n Team Name:".getBytes());
			 	output.write(teamName.getBytes());
				System.out.print("\nEnter College Name:");
				collegeName = scan.next();
				output.write("\n College Name:".getBytes());
				output.write(collegeName.getBytes());
				System.out.print("\nEnter Mobile No.:");
				mobileNo = scan.nextLong();	 
				mobile = mobileNo.toString(); 
				output.write("\n Mobile Number:".getBytes());
				output.write(mobile.getBytes());
				output.close();
